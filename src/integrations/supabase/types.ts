...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      batteries: {
        Row: {
          ...
          cep: string | null;
          cidade: string | null;
          classificacao: Database["public"]["Enums"]["battery_classification"] | null;
          code: string;
    ...
    Enums: {
      app_role: "admin" | "gerador" | "reciclador" | "transportadora" | "operador";
      ...
      lot_status:
        ...
        | "cancelado";
      org_member_role:
        "proprietario" | "gestor" | "operador" | "tecnico" | "financeiro" | "visualizador";
      org_status:
        | "cadastro_incompleto"
